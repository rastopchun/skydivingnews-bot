...
# Военно-политическое в ТЕКСТЕ новости — регенерируем (юр. риск для владельца в РФ).
# Путин/Греф/чиновники — можно; блокируем только явную военщину и Украину.
POLITICS_MILITARY_OUT = [
    r"нато\b", r"украин", r"зеленск", r"\bвсу\b", r"\bсво\b", r"мобилизац",
    r"ядер", r"донбас", r"\bднр\b", r"\bлнр\b",
]
